...
import { Shield, Lock, Mail, Github, Compass } from 'lucide-react';
  ...
  React.useEffect(() => {
    const handleMessage = (event: MessageEvent) => {
      ...
      if (event.data?.type === 'OAUTH_AUTH_SUCCESS') {
        // Auth handled via common storage, just redirect or let App handle it
      ...
      <div className="hidden lg:flex flex-col relative p-12 border-r border-white/5 bg-slate-950/50">
        ...
        <div className="relative z-10 flex items-center gap-4">
          <div className="w-10 h-10 border-2 border-viking-gold rotate-45 flex items-center justify-center">
            <span className="rotate-[-45deg] text-viking-gold font-bold text-xl">ᚻ</span>
          </div>
      ...
      <div className="flex items-center justify-center p-8 relative">
         ...
         >
            <div className="text-center lg:text-left">
              ...
              <p className="text-slate-400">Entre com suas credenciais ou convoque via Github</p>
            </div>

            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-300">Email do Clã</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="ragnar@heimdall.com"
                  />
                </div>
              </div>
            ...
            <p className="text-center text-sm text-slate-500">
              Precisa de acesso? <a href="#" className="text-viking-gold hover:underline">Fale com um Comandante</a>
            </p>
         </motion.div>
      </div>
    </div>
